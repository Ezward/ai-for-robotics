...
p3 = []
beta = 0.0
index = random.randint(0, N - 1)                   # choose a random cell
for i in range(len(p)):				               # pick same number of new samples
	beta = beta + random.uniform(0.0, maxw * 2.0)  # jump up to twice largest particle probability
