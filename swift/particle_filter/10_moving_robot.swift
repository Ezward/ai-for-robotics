...
public struct Robot {
	...
	mutating func set_noise(_ new_f_noise: Double, _ new_t_noise: Double, _ new_s_noise: Double) -> Robot {
	...
	func move(turn: Double, forward: Double) -> Robot {
		...
		return res.set_noise(self.forward_noise, self.turn_noise, self.sense_noise)
	}
	...
	*/
	...
	func measurement_prob(measurement: [Double]) -> Double {
